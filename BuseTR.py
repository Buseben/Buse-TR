...
▀▀▀▀▀▀▀▀▀▀▀▀▀▀          
    ...
    {Wh}[ 1 ] {Gr}IP Bilgi Toplama
    {Wh}[ 2 ] {Gr}IP izleyici
    {Wh}[ 3 ] {Gr}Numaradan bilgi toplama
    {Wh}[ 4 ] {Gr}Kullanıcı Adı Takibi
    {Wh}[ 0 ] {Gr}Exit
""")

input_user = input(f'\n   {Wh}@BUSE~# {Gr}') #OPSI MENU
...
if input_user == '1': #OPSI 1
    ...
    stderr.writelines(f"""{Wh}
             ...
             {Wh}--------------------------------
               {Wh}| {Gr}BUSE - TRACKER - IP ADDRESS {Wh}|
                {Wh}|       {Gr}@CODE BY BUSEBEN      {Wh}|
                {Wh}--------------------------------
 ▀▀▀▀▀▀▀▀▀▀▀▀▀▀
▀ ▀
▀ B U S E   ▀
...
▀▀▀▀▀▀▀▀▀▀▀▀▀▀          
    ...
    stderr.writelines(f"""{Wh}
             ...
             {Wh}----------------------------------
               {Wh}| {Gr}BUSE - TRACKER - PHONE NUMBER {Wh}|
                {Wh}|        {Gr}@CODE BY Buseben       {Wh}|
                {Wh}----------------------------------
 ▀▀▀▀▀▀▀▀▀▀▀▀▀▀
▀ ▀
...
▀▀▀▀▀▀▀▀▀▀▀▀▀▀          
    ...
    stderr.writelines(f"""{Wh}
            ...
            {Wh}----------------------------------
               {Wh}|  {Gr}BUSE - SHOW YOUR IP ADDRESS  {Wh}|
                {Wh}|        {Gr}@CODE BY Buseben       {Wh}|
                {Wh}----------------------------------
 ▀▀▀▀▀▀▀▀▀▀▀▀▀▀
▀ ▀
...
""")
    ...
    stderr.writelines(f"""{Wh}
             ...
             {Wh}----------------------------------
               {Wh}|    {Gr}BUSE - TRACKER USERNAME    {Wh}|
                {Wh}|        {Gr}@CODE BY Buseben       {Wh}|
                {Wh}----------------------------------
▀▀▀▀▀▀▀▀▀▀▀▀▀▀
▀ ▀
...
""")
    ...
    print(f"\n  {Wh}[{Ye}!{Wh}] {Ye}THANK'S FOR USING TOOL {Ye}BUSE-TRACK !")
else:
